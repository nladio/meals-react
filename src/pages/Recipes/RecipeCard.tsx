...
export function RecipeCard({ match }: RecipeCardProps) {
  ...
  return (
    <div className={`${bgColor} rounded-lg p-4 shadow-sm border-l-4 cursor-pointer transition-all hover:-translate-y-1 hover:shadow-lg active:scale-[0.98] active:shadow-sm h-full ${borderColor}`}>
